...
sources=['PlataApp.swift','CardOrderingView.swift','CardPhysics.swift','MetalCard.swift']
...
obj(112,'isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = CardFlowUITests.swift; sourceTree = "<group>";')
obj(212,f'isa = PBXBuildFile; fileRef = {uid(112)};')
...
obj(2,'isa = PBXGroup; path = Plata; sourceTree = "<group>"; children = ('+', '.join(uid(100+i) for i in range(4))+', '+uid(110)+');')
obj(3,f'isa = PBXGroup; name = Products; children = ({uid(111)}, {uid(113)}); sourceTree = "<group>";')
obj(4,f'isa = PBXGroup; path = PlataUITests; children = ({uid(112)}); sourceTree = "<group>";')
for n,isa,files in [(10,'PBXSourcesBuildPhase',[200,201,202,203]),(11,'PBXResourcesBuildPhase',[210]),(12,'PBXFrameworksBuildPhase',[]),(13,'PBXSourcesBuildPhase',[212]),(14,'PBXResourcesBuildPhase',[]),(15,'PBXFrameworksBuildPhase',[])]:
